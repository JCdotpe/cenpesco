...
echo $bandera.' / '.$titulo;
//----------------------------Guardar consulta
if($bandera==1 and $respuesta!=NULL)
{ 

$fecha=date('Y-m-d H:i:s');
$sql="INSERT INTO  cap_foro (mensaje,categoria,dni,fecha,ide,id_seccion) VALUES ('".$respuesta."','0','99999999','".$fecha."','".$id_foro."','".$id_seccion."')";
$result = mysql_query($sql);

echo '<meta http-equiv="Refresh" content="0;url=edit_ayuda.php">';
}
?>
...
?>
  <table width="700" border="0" cellpadding="2" cellspacing="0">
    <tr>
      <td width="736" align="left" valign="middle" class="titulo3">Formulario de Respuestas</td>
      </tr>

    <tr>
      <td align="left" valign="top" class="subtitulo">
      <form id="form1" name="form1" method="post" action="resp_ayuda.php">
        <table width="655" height="162" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td width="111" height="37" align="left" valign="top"><strong>Pregunta</strong>              <input name="id_foro" type="hidden" id="id_foro" value="<?php echo $id_foro; ?>" /></td>
            <td width="530" align="left" valign="top"><?php echo $pregunta; ?>&nbsp;</td>
          </tr>
          <tr>
            <td align="left" valign="top"><strong>Responder</strong></td>
            <td align="left" valign="top"><label>
              <textarea name="respuesta" cols="52" rows="3" class="texto2" id="respuesta"></textarea>
            </label></td>
          </tr>
          <tr>
            <td align="left" valign="top">&nbsp;</td>
            <td align="left"><label>
              <input name="button" type="submit" class="subtitulo" id="button" value="  Responder  " onclick="return formulario()" />
