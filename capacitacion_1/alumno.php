...
<div class=panel>
  <p>&nbsp;</p>
  <p><span class="titulo2">Aula Virtual - Mis compa&ntilde;eros de Aula<a href="agregar_notas.php" class="titulo2"></a></span><br />
  </p>
  <hr />
...
while($row = mysql_fetch_row($result))
	 {
	 $nombres=$row[2].' '.$row[3].' '.$row[4].' '.$row[5];
     $c=$c+1;
	 if($c<=4) 
	 { 
	 $division='';
	 ...
	 echo '<td width="25%" align="center"><span class="subtitulo"><b>'.strtoupper($nombres).'</b></span><br><span class="texto2"></span><br><img src="vista_foto.php?usuario='.$row[1].'&amp;id=4&rdz='.$aleatorio.'" border="0"  style="border:thin;border: 1px solid #0099FF"/><br /></td>'.$division.'';
