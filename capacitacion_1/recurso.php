...
<script type="text/javascript">
  jwplayer('reproductor').setup({
    ...
    'levels': [
       {
           'file': 'videos/ejemplo.flv'
       },
         ],
    'image': 'video/ejemplo.jpg',
    'controlbar': 'over',
    'modes': [
        {type: 'html5'},
...
<div class=panel>
  <p>&nbsp;</p>
  <p><span class="titulo2">Recursos de aprendizaje</span><br />
  </p>
  <hr />
  <table width="621" border="0" cellpadding="6" cellspacing="0">
    <tr>
      <td width="429" align="left" valign="middle" class="titulo3">No hay recursos publicados.</td>
      </tr>
