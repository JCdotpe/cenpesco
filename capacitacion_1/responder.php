...
{
$duracion=strtotime(date("Y-m-d").' '.$row[4].':00');
$titulo=$row[1];
...
$inis= date("H:i:s", strtotime("$inis -5 minutes"));
$finis= date("H:i:s", strtotime("$finis +1 minutes"));
...
$mysql="SELECT * FROM cap_resultado  WHERE dni='".$_SESSION["dni"]."' AND id_examen='".$id_examen."'";  
$r=mysql_query($mysql) or die ("No se puede hacer consulta");
...
<form action="recepcion.php" name="form1" id="form1" method="post">
   <table width="680" border="0" cellpadding="3" cellspacing="1">
    <?php
     ...
     $mysql="SELECT e.id_examen, e.titulo, e.fecha, e.hora_ini, e.hora_fin, p.id_pregunta, p.pregunta, p.r1, p.r2, p.r3, p.r4, p.r5, p.puntaje, p.respuesta FROM cap_examen AS e INNER JOIN cap_pregunta AS p on(e.id_examen=p.id_examen) WHERE  p.id_examen='".$id_examen."' ORDER BY RAND() LIMIT 20";  
    $r=mysql_query($mysql) or die ("No se puede hacer consulta");
    $c=0;
    ...
    ?>
    <tr>
       <td width="50" align="left"><td width="615"><b><?php echo $c.'.  '.$row[6]; ?>
      </tr>
    <tr>
       <td align="right" valign="top" class="subtitulo1">&nbsp;<input type="radio" name="re[<?php echo $c; ?>]" id="re<?php echo $c; ?>" value="A" style="width:35px;height:35px;border: 2px solid #b71;"/></td>
       <td align="left" valign="middle" class="subtitulo1"><?php echo 'A) '.$row[7];  ?></td>
    </tr>

    <tr>
       <td align="right" valign="top" class="subtitulo1">&nbsp;<input type="radio" name="re[<?php echo $c; ?>]" id="re<?php echo $c; ?>" value="B" style="width:35px;height:35px;border: 2px solid #b71;"/></td>
       <td align="left" valign="middle" class="subtitulo1"><?php echo'B) '.$row[8];  ?></td>
    </tr>

    <tr>
       <td align="right" valign="top" class="subtitulo1">&nbsp;<input type="radio" name="re[<?php echo $c; ?>]" id="re<?php echo $c; ?>" value="C" style="width:35px;height:35px;border: 2px solid #b71;"/></td>
       <td align="left" valign="middle" class="subtitulo1"><?php echo'C) '.$row[9];  ?></td>
    </tr>

    <tr>
       <td align="right" valign="top" class="subtitulo1">&nbsp;<input type="radio" name="re[<?php echo $c; ?>]" id="re<?php echo $c; ?>" value="D" style="width:35px;height:35px;border: 2px solid #b71;"/></td>
       <td align="left" valign="middle" class="subtitulo1"><?php echo'D) '.$row[10];  ?></td>
    </tr>

    <tr>
       <td align="right" valign="top" class="subtitulo1">&nbsp;<input type="radio" name="re[<?php echo $c; ?>]" id="re<?php echo $c; ?>" value="E" style="width:35px;height:35px;border: 2px solid #b71;"/></td>
       <td align="left" valign="middle" class="subtitulo1"><?php echo'E) '.$row[11]; ?></td>
    </tr>
...
document.getElementById("form1").submit();
 ...
 <?php
  ...
  echo ' <br/><br/><span class="subtitulo1">Acceso restringido a cuestionarios de examenes. <a href="principal.php" class="subtitulo1">Haga clic aquí para regresar al Aula Virtual.</a></span>';
  }
 ?>
</div>
