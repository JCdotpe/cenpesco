...
<div class=panel>
  ...
  <table width="708" border="0" cellpadding="6" cellspacing="0">
    <tr>
      <td width="696" align="left" valign="middle" ><span class="titulo3">1. Reporte de Notas General: </span><span class="title"><a href="report1.php?nb=ReporteGeneral" target="_blank" class="title">Ver</a> | <a href="report1_excel.php?nb=ReporteGeneral">Descargar</a></span></td>
      </tr>
      <?php  
  ...
  <p>&nbsp;</p>
  <p><span class="title">Modificar Notas</span><br />
  </p>
  <table width="600" border="0" cellpadding="2" cellspacing="0">
    <tr>
    <td height="88"><form action="editar_notas_parcial.php" method="post" name="form1" target="_blank" id="form1">
      
      <table width="600" border="0" cellpadding="0" cellspacing="1">
        <tr class="subtitu">
          <td width="267">Seleccionar un Ex&aacute;men</td>
          <td width="330">Seleccionar Departamento</td>
        </tr>
        <tr>
          <td><select name="id_examen" class="texto1" id="id_examen" onchange="llenar()">
            <option value="0" selected="selected">Seleccionar</option>
            <?php
