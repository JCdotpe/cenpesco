...
if($bandera==1)
{
//echo $sec.'/ '.$docente.' /'.$dni.' // '.$p1.' '.$p2.' '.$p3.' '.$p4.' '.$p5.' '.$p6.' '.$p7.' '.$p8.' '.$p9.' '.$p10.' '.$p11.' '.$p12.' '.$p13;
$sql="INSERT INTO  cap_percepcion (docente,dni,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,id,seccion) VALUES ('".$docente."','".$dni."','".$p1."','".$p2."','".$p3."','".$p4."','".$p5."','".$p6."','".$p7."','".$p8."','".$p9."','".$p10."','".$p11."','".$p12."','".$p13."','".$id."','".$sec."')";
...
<form id="form1" name="form1" method="post" action="evaluacion.php">
  <table width="800" border="0" cellpadding="3" cellspacing="0" style="border:thin;border: 1px solid #0099FF">
    <tr>
      <td colspan="6" align="center" valign="middle" bgcolor="#66FFFF" class="titulo1">FICHA DE EVALUACIÓN DEL CURSO</td>
    </tr>
    <tr>
      <td colspan="6" bgcolor="#DFDFDF" class="title">Esta ficha de evaluación es anónima y tiene por finalidad evaluar aspectos importantes de este curso, le sugerimos reponder todas las preguntas y con absoluta verdad.</td>
    </tr>
        <tr>
      <td width="38">&nbsp;</td>
