...
class Comunidad_model extends CI_MODEL
{
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      function get_report_1(){ //generar reporte cuando  N < 0.3 or  N > 10
        $sql = '
              select id,NFORM, NOM_SEDE, NOM_DD, NOM_PP, NOM_DI, NOM_CCPP, S3_21_1_1_H,S3_21_2_1_M,S3_21_1_2_H,S3_21_2_2_M,S3_21_1_3_H,S3_21_2_3_M,S3_21_1_4_H,
      ...
      function get_report_2(){
        $sql = '
              select id,NFORM, NOM_SEDE, NOM_DD, NOM_PP, NOM_DI, NOM_CCPP,  S4_1, S4_1_C
