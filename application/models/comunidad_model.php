...
function get_tabulado_201()
{
      $q = $this->db->query('
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s1 on c.id = s1.comunidad_id  where S3_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s3 on c.id = s3.comunidad_id  where S3_1 = 9 group by nom_dd) as NEP on DEP.ccdd  = NEP.ccdd ;
        ');
      return $q;
}
...
function get_tabulado_202()
{
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s1 on c.id = s1.comunidad_id  where S3_2 is not null group by nom_dd) as CO       on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s2 on c.id = s2.comunidad_id  where S3_2 = 9 group by nom_dd) as NEP      on DEP.ccdd  = NEP.ccdd ;
        ");
      return $q;
}
...
function get_tabulado_203()
{
      $q = $this->db->query('
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_3 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_3 = 9 group by nom_dd) as NP on DEP.ccdd  = NP.ccdd ;
        ');
      return $q;
}
...
function get_tabulado_204()
{
      $q = $this->db->query('
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_4_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_4_4 = 9 group by nom_dd) as C5 on DEP.ccdd  = C5.ccdd  ;
        ');
      return $q;
}
...
function get_tabulado_205()
{
      $q = $this->db->query('
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_5_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_5_1 = 9 group by nom_dd) as C4 on DEP.ccdd  = C4.ccdd  ;
        ');
      return $q;
}
...
function get_tabulado_206()
{
      $q = $this->db->query('
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_6_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_6_5 = 9 group by nom_dd) as C6 on DEP.ccdd  = C6.ccdd  ;   
        ');
      return $q;
}
...
function get_tabulado_207()
{
      $q = $this->db->query('
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_7 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_7 = 9 group by nom_dd) as C6 on DEP.ccdd  = C6.ccdd ;
                  ');
      return $q;
}
...
function get_tabulado_208()
{
      $q = $this->db->query('
          ...
          COALESCE(C1.t,0) as INTERRUPCION, COALESCE(C2.t,0) as RESTRINGIDO, COALESCE(C3.t,0) as COSTO,  COALESCE(C4.t,0) as F_MANTENIMIENTO ,  COALESCE(C5.t,0) as OTRA,  COALESCE(C6.t,0) as NEP
          from (select  distinct(departamento), ccdd from marco order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_8_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_8_5 = 1 group by nom_dd) as C5 on DEP.ccdd  = C5.ccdd  
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_8_5 = 9 group by nom_dd) as C6 on DEP.ccdd  = C6.ccdd ;
        ');
      return $q;
}
...
{           
      $q = $this->db->query('
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_9_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_9_6 = 9 group by nom_dd) as C7 on DEP.ccdd  = C7.ccdd ;
        ');
      return $q;
}
...
{           /* TABULADO N° 10 ---->destino del desague*/
      $q = $this->db->query('
          select 
          DEP.CCDD, DEPARTAMENTO, COALESCE(CO.t,0) AS TOTAL,  
          COALESCE(C1.t,0) as RIO, COALESCE(C2.t,0) as BOSQUE, COALESCE(C3.t,0) as LAGUNA,  COALESCE(C4.t,0) as CANAL,  COALESCE(C5.t,0) as MAR,  COALESCE(C6.t,0) as POZO,  COALESCE(C7.t,0) as OTRO,  COALESCE(C8.t,0) as NEP
          from (select  distinct(departamento), ccdd from marco order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_10_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_10_6 = 1 group by nom_dd) as C6 on DEP.ccdd  = C6.ccdd
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_10_7 = 1 group by nom_dd) as C7 on DEP.ccdd  = C7.ccdd
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_10_7 = 9 group by nom_dd) as C8 on DEP.ccdd  = C8.ccdd ;
        ');
      return $q;
}
...
{         /* TABULADO N° 210 ---->serviocios de la comunicacion */
      $q = $this->db->query('
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_11_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_11_6 = 9 group by nom_dd) as C7 on DEP.ccdd  = C7.ccdd  ;
                  ');
      return $q;
}
...
{         /* TABULADO N° 12 ---->destino final basura */
      $q = $this->db->query('
          ...
          COALESCE(C6.t,0) as ENTERRADA,COALESCE(C7.t,0) as OTRO,COALESCE(C8.t,0) as NEP
          from (select  distinct(departamento), ccdd from marco order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_12_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_12_7 = 1 group by nom_dd) as C7 on DEP.ccdd  = C7.ccdd 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_12_7 = 9 group by nom_dd) as C8 on DEP.ccdd  = C8.ccdd   ;
        ');
      return $q;
}
...
{         /* TABULADO N° 13 -------> existen minas */
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s1 on c.id = s1.comunidad_id  where S3_13 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s2 on c.id = s2.comunidad_id  where S3_13 = 9 group by nom_dd) as C3 on DEP.ccdd  = C3.ccdd ;
        ");
      return $q;
}
...
{         /* TABULADO N° 14 -------> existen hidrocarburos */
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as SI, COALESCE(C2.t,0) as 'NO', COALESCE(C3.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s1 on c.id = s1.comunidad_id  where S3_14 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s2 on c.id = s2.comunidad_id  where S3_14 = 9 group by nom_dd) as C3 on DEP.ccdd  = C3.ccdd  ;
        ");
      return $q;
}
...
{         /* TABULADO N° 15 -------> existen contaminacion */
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as SI, COALESCE(C2.t,0) as 'NO', COALESCE(C3.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s1 on c.id = s1.comunidad_id  where S3_15 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s2 on c.id = s2.comunidad_id  where S3_15 = 9 group by nom_dd) as C3 on DEP.ccdd  = C3.ccdd  ;
        ");
      return $q;
}
...
{       /* TABULADO N° 16 ---->tipo de contaminacion*/
      $q = $this->db->query('
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_16_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_16_5 = 9 group by nom_dd) as C6 on DEP.ccdd  = C6.ccdd ;    
        ');
      return $q;
}
...
{         /* TABULADO N° 17 ---->origen contaminacion */
      $q = $this->db->query('
          ...
          COALESCE(C7.t,0) as DETERGENTE, COALESCE(C8.t,0) as FABRICA , COALESCE(C9.t,0) as COMERCIO,  COALESCE(C10.t,0) as PECUARIA,  COALESCE(C11.t,0) as TRANSPORTE,  COALESCE(C12.t,0) as QUEMA,  COALESCE(C13.t,0) as OTRO,  COALESCE(C14.t,0) as NEP 
          from (select  distinct(departamento), ccdd from marco order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_17_1  is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_17_10 = 1 group by nom_dd) as C10 on DEP.ccdd  = C10.ccdd 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_17_11 = 1 group by nom_dd) as C11 on DEP.ccdd  = C11.ccdd 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_17_12 = 1 group by nom_dd) as C12 on DEP.ccdd  = C12.ccdd 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_17_13 = 1 group by nom_dd) as C13 on DEP.ccdd  = C13.ccdd 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_17_13 = 9 group by nom_dd) as C14 on DEP.ccdd  = C14.ccdd  ;
        ');
      return $q;
}
...
{     /* TABULADO N° 18 ---->origen contaminacion */
      $q = $this->db->query('
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_18_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_18_8 = 9 group by nom_dd) as C9 on DEP.ccdd  = C9.ccdd  ;
        ');
      return $q;
}
...
{       /* TABULADO N° 19 ---->tipo de violencia*/
      $q = $this->db->query('
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_19_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion3 s on c.id = s.comunidad_id  where S3_19_5 = 9 group by nom_dd) as C6 on DEP.ccdd  = C6.ccdd ;   
        ');
      return $q;
}
...
{       /* TABULADO N° 20 ------->  existe centros educativos */
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as SI, COALESCE(C2.t,0) as 'NO', COALESCE(C3.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion4 s on c.id = s.comunidad_id  where S4_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion4 s on c.id = s.comunidad_id  where S4_1 = 9 group by nom_dd) as C3 on DEP.ccdd  = C3.ccdd  ;   
        ");
      return $q;
}
...
{          /* TABULADO N° 220 ---->tipo de educacion*/       
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion4 s on c.id = s.comunidad_id  where S4_2_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion4 s on c.id = s.comunidad_id  where S4_2_1 = 9 group by nom_dd) as C6 on DEP.ccdd  = C6.ccdd ;
        ");
      return $q;
}
...
{           /* TABULADO N° 22 ---->servicios en las instituciones*/      
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion4 s on c.id = s.comunidad_id  where S4_3_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion4 s on c.id = s.comunidad_id  where S4_3_1   = 9 group by nom_dd) as C14 on DEP.ccdd  = C14.ccdd ;
        ");
      return $q;
}
...
{          /* TABULADO N° 23 ------->  existe locales de salud */       
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as SI, COALESCE(C2.t,0) as 'NO', COALESCE(C3.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion5 s on c.id = s.comunidad_id  where S5_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion5 s on c.id = s.comunidad_id  where S5_1 = 9 group by nom_dd) as C3 on DEP.ccdd  = C3.ccdd  ; 
        ");
      return $q;
}
...
{          /* TABULADO N° 25 ---->enfermedades accidentes*/       
      $q = $this->db->query("
          select 
          DEP.CCDD, DEPARTAMENTO, CO.t AS TOTAL,   
          COALESCE(C1.t,0) as   TBC, COALESCE(C2.t,0) as NEUMONIA, COALESCE(C3.t,0) as COLERA,  COALESCE(C4.t,0) as VOMITOS,  COALESCE(C5.t,0) as DESNUTRICION,
          ...
          COALESCE(C16.t,0) as FRACTURAS, COALESCE(C17.t,0) as RESPIRATORIAS, COALESCE(C18.t,0) as OTRO, COALESCE(C19.t,0) as NEP
          from (select  distinct(departamento), ccdd from marco order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion5 s on c.id = s.comunidad_id  where S5_3_1  is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion5 s on c.id = s.comunidad_id  where S5_3_18   = 1 group by nom_dd) as C18 on DEP.ccdd  = C18.ccdd 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion5 s on c.id = s.comunidad_id  where S5_3_18   = 9 group by nom_dd) as C19 on DEP.ccdd  = C19.ccdd ;
        ");
      return $q;
}
...
{          /* TABULADO N° 26 ------->  existe afiliacion */       
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as SI, COALESCE(C2.t,0) as 'NO', COALESCE(C3.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion6 s on c.id = s.comunidad_id  where S6_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion6 s on c.id = s.comunidad_id  where S6_1 = 9 group by nom_dd) as C3 on DEP.ccdd  = C3.ccdd  ;
        ");
      return $q;
}
...
{          /* TABULADO N° 27 ---->que organizaciones  */       
      $q = $this->db->query("
          ...
          COALESCE(C6.t,0) as A_AGRICULTORES,  COALESCE(C7.t,0)  as OTRO,  COALESCE(C8.t,0)  as NINGUNO,  COALESCE(C9.t,0)  as NEP
          from (select  distinct(departamento), ccdd from marco order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion6 s on c.id = s.comunidad_id  where S6_3_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion6 s on c.id = s.comunidad_id  where S6_3_8 = 1 group by nom_dd) as C8 on DEP.ccdd  = C8.ccdd
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion6 s on c.id = s.comunidad_id  where S6_3_8 = 9 group by nom_dd) as C9 on DEP.ccdd  = C9.ccdd ;
        ");
      return $q;
}
...
{          /* TABULADO N° 28 ---->beneficiados programas*/       
      $q = $this->db->query("
            ...
            COALESCE(C11.t,0) as P_JUNTOS, COALESCE(C12.t,0) as P_SEMBRANDO, COALESCE(C13.t,0) as P_65, COALESCE(C14.t,0) as CUNAMAS, COALESCE(C15.t,0) as FISE, COALESCE(C16.t,0) as OTRO,
            COALESCE(C17.t,0) as NINGUNO, COALESCE(C18.t,0) as NEP
            from (select  distinct(departamento), ccdd from marco order by departamento) as DEP 
            left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion6 s on c.id = s.comunidad_id  where S6_4_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
            ...
            left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion6 s on c.id = s.comunidad_id  where S6_4_16   = 1 group by nom_dd) as C16 on DEP.ccdd  = C16.ccdd 
            left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion6 s on c.id = s.comunidad_id  where S6_4_17   = 1 group by nom_dd) as C17 on DEP.ccdd  = C17.ccdd 
            left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion6 s on c.id = s.comunidad_id  where S6_4_17   = 9 group by nom_dd) as C18 on DEP.ccdd  = C18.ccdd  ;
        ");
      return $q;
}

function get_tabulado_229()
{          /* TABULADO N° 229 ---->actividad*/       
      $q = $this->db->query("
          select 
          DEP.CCDD, DEPARTAMENTO, CO.t AS TOTAL,   
          ...
          COALESCE(C6.t,0) as CAZA, COALESCE(C7.t,0) as RECOLECCION, COALESCE(C8.t,0) as ARTESANIA,  COALESCE(C9.t,0) as COMERCIO,  COALESCE(C10.t,0) as CONSTRUCCION,  
          COALESCE(C11.t,0) as P_MARITIMA,  COALESCE(C12.t,0) as OTRO,  COALESCE(C13.t,0) as NEP
          from (select  distinct(departamento), ccdd from marco order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_1_1  is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_1_10 = 1 group by nom_dd) as C10 on DEP.ccdd  = C10.ccdd 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_1_11 = 1 group by nom_dd) as C11 on DEP.ccdd  = C11.ccdd 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_1_12 = 1 group by nom_dd) as C12 on DEP.ccdd  = C12.ccdd
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_1_12 = 9 group by nom_dd) as C13 on DEP.ccdd  = C13.ccdd ;
        ");
      return $q;
}
...
{           /* TABULADO N° 30 ---->pesca en*/      
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_2_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_2_1 = 9 group by nom_dd) as C10 on DEP.ccdd  = C10.ccdd ;
        ");
      return $q;
}
...
{          /* TABULADO N° 31 ---->meses que realizan*/       
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_3_1  is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_3_1   = 9 group by nom_dd) as C13 on DEP.ccdd  = C13.ccdd  ;
        ");
      return $q;
}
...
{          /* TABULADO N° 32 ---->meses de mayor productividad*/       
      $q = $this->db->query("
          ...
          COALESCE(C11.t,0) as NOV, COALESCE(C12.t,0) as DIC, COALESCE(C13.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_4_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_4_1   = 9 group by nom_dd) as C13 on DEP.ccdd  = C13.ccdd  ;
        ");
      return $q;
}
...
{          /* TABULADO N° 232 ---->que pezcan? */       
      $q = $this->db->query("
          select 
          DEP.CCDD, DEPARTAMENTO, CO.t AS TOTAL,   
          COALESCE(C1.t,0) as   'Bagre', COALESCE(C2.t,0) as 'Boquichico', COALESCE(C3.t,0) as 'Camarón_río',  COALESCE(C4.t,0) as 'Carachama',  COALESCE(C5.t,0) as 'Carachi_amarillo',
          COALESCE(C6.t,0) as  'Doncella', COALESCE(C7.t,0) as 'Fasaco', COALESCE(C8.t,0) as 'Lisa',  COALESCE(C9.t,0) as 'Palometa',  COALESCE(C10.t,0) as 'Pejerrey',
          COALESCE(C11.t,0) as 'Sabalo', COALESCE(C12.t,0) as 'Sardina', COALESCE(C13.t,0) as 'Tilapia', COALESCE(C14.t,0) as 'Trucha', COALESCE(C15.t,0) as 'Zungaro'
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_5_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
...
{            /* TABULADO N° 233 ----> tecnicas*/  
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_6_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_6_4 = 9 group by nom_dd) as C5 on DEP.ccdd  = C5.ccdd  ;
        ");
      return $q;
}
...
{          /* TABULADO N° 234 ---->especies acuicolas*/
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_7_1  is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_7_16 = 9 group by nom_dd) as C17 on DEP.ccdd  = C17.ccdd;
        ");
      return $q;
}
...
{            /* TABULADO N° 235 ---->enfermedades accidentes*/
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_8_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_8_19 = 9 group by nom_dd) as C20 on DEP.ccdd  = C20.ccdd ;
        ");
      return $q;
}

function get_tabulado_237()
{          /* TABULADO N° 236 ---->afrotnar los problemas*/
      $q = $this->db->query("
          select 
          DEP.CCDD, DEPARTAMENTO, CO.t AS TOTAL,  
          ...
          COALESCE(C11.t,0) as RECICLAJE, COALESCE(C12.t,0) as R_SANITARIO, COALESCE(C13.t,0) as OTRO, COALESCE(C14.t,0) as NINGUNO, COALESCE(C15.t,0) as NEP
          from (select  distinct(departamento), ccdd from marco order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_9_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_9_14 = 1 group by nom_dd) as C14 on DEP.ccdd  = C14.ccdd 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_9_14 = 9 group by nom_dd) as C15 on DEP.ccdd  = C15.ccdd ;
        ");
      return $q;
}
...
{          /* TABULADO N° 237 ---->ESTABLECIMIENTOS*/
      $q = $this->db->query("
          ...
          COALESCE(C6.t,0) as V_FERRETERIA, COALESCE(C7.t,0) as FRIGORIFICO, COALESCE(C8.t,0) as R_MOTORES,  COALESCE(C9.t,0) as OTRO,  COALESCE(C10.t,0) as NINGUNO,  COALESCE(C11.t,0) as NEP
          from (select  distinct(departamento), ccdd from marco order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_10_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd 
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_10_10 = 1 group by nom_dd) as C10 on DEP.ccdd  = C10.ccdd
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_10_10 = 9 group by nom_dd) as C11 on DEP.ccdd  = C11.ccdd;
        ");
      return $q;
}
...
{          /* TABULADO N° 238 -------> existen punto desembarque */
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as SI, COALESCE(C2.t,0) as 'NO', COALESCE(C3.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s1 on c.id = s1.comunidad_id  where S7_11 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s2 on c.id = s2.comunidad_id  where S7_11 = 9 group by nom_dd) as C3 on DEP.ccdd  = C3.ccdd ;
        ");
      return $q;
}
...
{          /* TABULADO N° 239 ----> tipo de punto desembarque*/
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_12_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_12_4 = 9 group by nom_dd) as C5 on DEP.ccdd  = C5.ccdd  ;
        ");
      return $q;
}

function get_tabulado_241()
{          /* TABULADO N° 241 ---->equipamiento*/
      $q = $this->db->query("
          /* TABULADO N° 241 ---->equipamiento*/
          select 
          DEP.CCDD, DEPARTAMENTO, COALESCE(CO.t,0) AS TOTAL,
          ...
          COALESCE(C11.t,0) as Z_COMERCIALIZACION, COALESCE(C12.t,0) as OTRO,  COALESCE(C13.t,0) as NINGUNO,  COALESCE(C14.t,0) as NEP
          from (select  distinct(departamento), ccdd from marco order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_13_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_13_13 = 1 group by nom_dd) as C13 on DEP.ccdd  = C13.ccdd 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_13_13 = 9 group by nom_dd) as C14 on DEP.ccdd  = C14.ccdd ;
...
{          /* TABULADO N° 241 -------> oficina administrativa */
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as SI, COALESCE(C2.t,0) as 'NO', COALESCE(C3.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s1 on c.id = s1.comunidad_id  where S7_14  is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s2 on c.id = s2.comunidad_id  where S7_14 = 9 group by nom_dd) as C3 on DEP.ccdd  = C3.ccdd  ;
        ");
      return $q;
}
...
{          /* TABULADO N° 243 ---->servicios de comunicacion  */
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_16_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_16_5 = 9 group by nom_dd) as C6 on DEP.ccdd  = C6.ccdd   ;
        ");
      return $q;
}
...
{          /* TABULADO N° 244 ------->  capacitacion ? */
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as SI, COALESCE(C2.t,0) as 'NO', COALESCE(C3.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_1  is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_1 = 9 group by nom_dd) as C3 on DEP.ccdd  = C3.ccdd  ;
        ");
      return $q;
}
...
{          /* TABULADO N° 245 ---->temas de capacitacion*/
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_2_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_2_12 = 9 group by nom_dd) as C13 on DEP.ccdd  = C13.ccdd;
        ");
      return $q;
}
...
{          /* TABULADO N° 246 ---->quienes capacitaron*/
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_3_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_3_10 = 9 group by nom_dd) as C11 on DEP.ccdd  = C11.ccdd ;
        ");
      return $q;
}
...
{          /* TABULADO N° 247 ----> calificacion del ministerio de produccion*/
      $q = $this->db->query("
          ...
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_1 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_1 = 9 group by nom_dd) as C7 on DEP.ccdd  = C7.ccdd;
        ");
      return $q;
}
...
{          /* TABULADO N° 248 ----> calificacion de FONDOPES*/
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as MUY_BUENO, COALESCE(C2.t,0) as BUENO, COALESCE(C3.t,0) as REGULAR,  COALESCE(C4.t,0) as MALO,  COALESCE(C5.t,0) as MUY_MALO, COALESCE(C6.t,0) as NO_CONOCE, COALESCE(C7.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_2 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_2 = 9 group by nom_dd) as C7 on DEP.ccdd  = C7.ccdd;
...
{          /* TABULADO N° 249 ----> calificacion de ITP*/
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as MUY_BUENO, COALESCE(C2.t,0) as BUENO, COALESCE(C3.t,0) as REGULAR,  COALESCE(C4.t,0) as MALO,  COALESCE(C5.t,0) as MUY_MALO, COALESCE(C6.t,0) as NO_CONOCE, COALESCE(C7.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_3 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_3 = 9 group by nom_dd) as C7 on DEP.ccdd  = C7.ccdd;
        ");
      return $q;
}
...
{          /* TABULADO N° 250 ----> calificacion de IMARPE*/
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as MUY_BUENO, COALESCE(C2.t,0) as BUENO, COALESCE(C3.t,0) as REGULAR,  COALESCE(C4.t,0) as MALO,  COALESCE(C5.t,0) as MUY_MALO, COALESCE(C6.t,0) as NO_CONOCE, COALESCE(C7.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_4 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_4 = 9 group by nom_dd) as C7 on DEP.ccdd  = C7.ccdd;
        ");
      return $q;
}
...
{          /* TABULADO N° 251 ----> calificacion de MINAM*/
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as MUY_BUENO, COALESCE(C2.t,0) as BUENO, COALESCE(C3.t,0) as REGULAR,  COALESCE(C4.t,0) as MALO,  COALESCE(C5.t,0) as MUY_MALO, COALESCE(C6.t,0) as NO_CONOCE, COALESCE(C7.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_5 = 1  is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_5 = 9 group by nom_dd) as C7 on DEP.ccdd  = C7.ccdd;
        ");
      return $q;
}

function get_tabulado_253()
{          /* TABULADO N° 252 ----> calificacion de SANIPES*/
      $q = $this->db->query("
          ...
          COALESCE(C1.t,0) as MUY_BUENO, COALESCE(C2.t,0) as BUENO, COALESCE(C3.t,0) as REGULAR,  COALESCE(C4.t,0) as MALO,  COALESCE(C5.t,0) as MUY_MALO, COALESCE(C6.t,0) as NO_CONOCE, COALESCE(C7.t,0) as NEP
          from (select  distinct(departamento), ccdd from departamentos_tab order by departamento) as DEP 
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_6 is not null group by nom_dd) as CO on DEP.ccdd  = CO.ccdd  
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion8 s on c.id = s.comunidad_id  where S8_4_6 = 9 group by nom_dd) as C7 on DEP.ccdd  = C7.ccdd;
        ");
      return $q;
}
