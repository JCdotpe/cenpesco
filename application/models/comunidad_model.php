...
{          /* TABULADO N° 232 ---->que pezcan? */       
      $q = $this->db->query("
          ...
          left join (select ccdd,  count(*) as t  from comunidad c inner join comunidad_seccion7 s on c.id = s.comunidad_id  where S7_5_49 = 9 group by nom_dd) as C50 on DEP.ccdd  = C50.ccdd; 
        ");
      return $q;
}
