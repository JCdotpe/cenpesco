...
class Pesc_seccion9 extends CI_Controller {
	...
	public function index()
	{
		...
		if($is_ajax){
			...
			// }
			if ($this->pescador_model->consulta_in_seccion($id,'pesc_seccion9')->num_rows() == 0) {
				...
				// actualiza
					if($this->pescador_model->update_pesc_seccion('pesc_seccion9',$c_data,$id) > 0){
						$flag = 1;
						$msg = 'Se ha modificado satisfactoriamente la Seccion IX';
					}
