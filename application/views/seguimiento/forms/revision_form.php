	...
	echo '</div>'; 		
		...
		echo '<div class="row-fluid">';
			...
			echo '<div class="span6">';
				...
				echo '<a href="'. site_url('seguimiento/revision/get_todo') . '" class="btn btn-success pull-left" target="_blank">Visualizar</a>';
		   	echo '</div>';
...
//FIN MESSAGES
    ...
    submitHandler: function(form) {
		...
		if (($("#F_PES").val()  == 0 ) && ($("#F_ACU").val() == 0 ) && ($("#F_COM").val() == 0 )) {
	        ...
	        $.ajax({
	            url: CI.base_url + "seguimiento/revision/grabar",
	            type:'POST',
	            data:form_data,
	            dataType:'json',
