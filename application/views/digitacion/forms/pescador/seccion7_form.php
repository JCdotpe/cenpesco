...
/////////////////////////////////////////////PREGUNTA 4
				echo '<div class="question">';
			echo '<p>4. De la cantidad anual de su pesca, ¿Qué porcentaje destinó a:</p>';	
				echo '<div class="row-fluid">';
						echo '<table class="table table-condensed" id="emb_table">';
					              echo '<thead>';
					                echo '<tr>';
					                  echo '<th class="span3"></th>';
					                  echo '<th class="span1">Destinos</th>';
					                   echo '<th class="span3">%</th>';
					                echo '</tr>';
					              echo '</thead>';
					              echo '<tbody>';
...
/////////////////////////////////////////////PREGUNTA 5
				echo '<div class="question">';
			echo '<p>5. ¿Qué especies vendió y cuál fue el precio promedio por kilo?</p>';	
				echo '<div class="row-fluid">';
						echo '<table class="table table-condensed" id="emb_table">';
					              echo '<thead>';
					                echo '<tr>';
...
/////////////////////////////////////////////PREGUNTA 6
		...
		echo '<div class="question">';
			echo '<p>6. En los últimos 12 meses, ¿Cuál fue su ganancia neta promedio mensual? </p>';	
				echo '<div class="row-fluid">';
...
/////////////////////////////////////////////PREGUNTA 8
				echo '<div class="question">';
			echo '<p>8. En los últimos 12 meses, ¿A quién vendió el producto de su pesca?</p>';	
				echo '<div class="row-fluid">';
						echo '<table class="table table-condensed" id="emb_table">';
					              echo '<thead>';
					                echo '<tr>';
...
/////////////////////////////////////////////PREGUNTA 9
				echo '<div class="question">';
			echo '<p>9. ¿La extracción de su pesca la vendió:</p>';	
				echo '<div class="row-fluid">';
						echo '<table class="table table-condensed" id="emb_table">';
					              echo '<thead>';
					                echo '<tr>';
...
$('#S7_206, #S7_10_4').change(function() {
	var th = $(this).val();
...
$('#S7_4_1').change(function() {
	var th = $(this).val();
	var des7 = $('input.wothing7');
	if(th == 0){
		des7.val('')
...
$('#S7_4_4').change(function() {
	var th = $(this).val();
	var des = $('#' + $(this).attr('id') + '_O, #S7_4_4_1');
	if(th == 1){
		des.removeAttr('disabled');
	}else{
		des.val('')
