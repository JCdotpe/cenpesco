...
echo '<div class="well modulo" style="padding-bottom: 20px !important; padding-top: 20px !important;">';
	...
	echo '<h4>SECCIÓN III. CARACTERÍSTICAS Y SERVICIOS DE LA COMUNIDAD</h4>';
		...
		echo '<div class="span6">';
				...
				echo '<div class="preguntas preguntas_sub2" style="padding-bottom: 66px !important" id="SEC3_4">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="control-group-pp offset1 span7">';	
										echo form_label('Otra ', $S3_4_4['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls-pp">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									...
									echo '<div class="control-group-pp offset1 span2">';	
										echo form_label('Especifique', $S3_4_4_O['id'], $label_class);
									echo '</div>'; 
		...
		echo '<div class="span6">';
				...
				echo '<div class="preguntas preguntas_sub2" id="SEC3_6">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Otro?', $S3_6_5['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span2 offset1">';	
										echo form_label('Especifique', $S3_6_5_O['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp span7">';
										echo '<div class="controls">';
				...
				echo '<div class="preguntas preguntas_sub2" style="padding-bottom: 0px !important" id="SEC3_8">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Interrupciones / cortes de agua', $S3_8_1['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Otra ', $S3_8_4['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									...
									echo '<div class="span2 offset1">';	
										echo form_label('Especifique', $S3_8_4_O['id'], $label_class);
									echo '</div>'; 
		...
		echo '<div class="span6">';
				...
				echo '<div class="preguntas preguntas_sub2" style="padding-bottom: 0px !important" id="SEC3_10">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Otro', $S3_10_5['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span2 offset1">';	
										echo form_label('Especifique', $S3_10_5_O['id'], $label_class);
									echo '</div>'; 
				...
				////////////////////////////////////////////////////////////////////////////////////////////////////////
				///////////////////////////////////////////// PREGUNTA 11
				echo '<div class="preguntas preguntas_sub2" style="padding-bottom: 36px !important" id="SEC3_11">';
				...
				echo '<div class="preguntas preguntas_sub2" id="SEC3_12">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Otro ', $S3_12_6['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
												echo form_input($S3_12_6); 
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span2 offset1">';	
										echo form_label('Especifique', $S3_12_6_O['id'], $label_class);
									echo '</div>'; 
				...
				////////////////////////////////////////////////////////////////////////////////////////////////////////
				///////////////////////////////////////////// PREGUNTA 13
				echo '<div class="preguntas preguntas_sub2" style="padding-bottom: 60px !important" id="SEC3_13">';
				...
				////////////////////////////////////////////////////////////////////////////////////////////////////////
				///////////////////////////////////////////// PREGUNTA 14
				echo '<div class="preguntas preguntas_sub2" style="padding-bottom: 60px !important" id="SEC3_14">';
						echo form_label('14. ¿Existen empresas que explotan hidrocarburos cerca a la comunidad?', $S3_14['id'], $label_class);
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="control-group offset1 span2">';
										echo '<div class="controls">';
		...
		echo '<div class="span6">';
				...
				echo '<div class="preguntas preguntas_sub2" id="SEC3_16">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Otro ', $S3_16_5['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span2 offset1">';	
										echo form_label('Especifique', $S3_16_5_O['id'], $label_class);
									echo '</div>'; 
				...
				echo '<div class="preguntas preguntas_sub2" style="padding-bottom: px !important" id="SEC3_17">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Otro ', $S3_17_8['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span2 offset1">';	
										echo form_label('Especifique', $S3_17_8_O['id'], $label_class);
									echo '</div>'; 
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Otro ', $S3_17_9['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									...
									echo '<div class="span2 offset1">';	
										echo form_label('Especifique', $S3_17_9_O['id'], $label_class);
									echo '</div>'; 
				...
				echo '<div class="preguntas preguntas_sub2" style="padding-bottom: 20px !important" id="SEC3_18">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Otro', $S3_18_7['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Otro', $S3_18_8['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
				...
				echo '<div class="preguntas preguntas_sub2" style="padding-bottom: 11px !important" id="SEC3_19">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Violencia doméstica (Contra mujeres, niños, ancianos)', $S3_19_1['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('Otro ', $S3_19_4['id'], $label_class);
									echo '</div>'; 
									echo '<div class="control-group-pp  span2">';
										echo '<div class="controls">';
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="control-group-pp offset1 span2">';
										echo form_label('Especifique', $S3_19_4_O['id'], $label_class);
									echo '</div>'; 
						...
						echo '<div class="row-fluid">';
							echo '<div class="span12">';
									echo '<div class="span7 offset1">';	
										echo form_label('NINGUNA', $S3_19_5['id'], $label_class);
									echo '</div>'; 
	...
	//validacion
		$("#seccion3").validate({
			...
			//PREGUNTA 20
				//horas
				S3_21_1_1_H : {
		            range:"Hora no válido",
		        }, 
				//minutos
				S3_21_2_1_M : {
		            ranges:"Minuto no válido",
		        }, 
				//horas
				S3_21_1_2_H : {
		            range:"Hora no válido",
