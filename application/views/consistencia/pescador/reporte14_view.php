...
<div class="row-fluid">
    <div class="span2">
 	...
 	<div class="span10" id="freg">
    	<h4>VERIFICAR EL MATERIAL DE CONSTRUCCION DE LAS PAREDES Y EL MATERIAL DE CONSTRUCCION DE LOS PISOS DE LA VIVIENDA</h4>
    	<?php
				echo '<table border="1" class="table table-hover table-condensed">';
					echo '<thead>';
						...
						echo '<th>El material predominante en los pisos es:</th>';																											
						echo '</tr>';
					echo '</thead>';
					echo '<tbody>';
					$i = 1;
