...
<div class="row-fluid well top-conv" style="background-color:#A9DDFE;border: 1px solid #BEBEBE;">
  ...
  <div class="span3 controles hide">
...
<!--     <tr>
      ...
      <th><input type="text" name="" value="ODEI" class="search_init input-small" /></th>
      <th><input type="text" name="" value="Cargo" class="search_init input-small" /></th>
      <th><input type="text" name="" value="CV" class="search_init input-small" /></th>
  ...
  <?php $this->load->view('convocatoria/includes/footer_view.php'); ?>
      ...
      oTable = $('#t_regs').dataTable({
        ...
        "bProcessing": true,
              "bServerSide": true,
              "sServerMethod": "POST",
              "sAjaxSource": '<?php echo site_url('convocatoria/registrados/getTable') ?>',
