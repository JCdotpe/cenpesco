...
<div class="row-fluid well top-conv" style="background-color:#A9DDFE;border: 1px solid #BEBEBE;">
  ...
  <div class="span1 controles hide">
    <?php echo form_button('sel','Deseleccionar', 'class="btn btn-danger" id="sel" style="margin-top:5px"'); ?>
  </div>
  ...
  <?php $this->load->view('convocatoria/includes/footer_view.php'); ?>
      ...
      oTable = $('#t_regs').dataTable({
        ...
        "bProcessing": true,
              "bServerSide": true,
              "sServerMethod": "POST",
              "sAjaxSource": '<?php echo site_url('convocatoria/capacitar/getTable') ?>',
      "fnServerParams": function ( aoData ) {
       ...
       $('#ver').click(function() {
          ...
          var pea = getObjects(<?php echo json_encode($pea->result()); ?>, 'ubigeo', $('#departamento').val())
          //console.log(pea);
          //pea[0].ubigeo
        ...
        $('#sel').click(function() {
                $("#LoadingImage").show();
                                ...
                                $("#LoadingImage").hide();
                                      ...
                                      if(nro_cap == 0){
                                          alert('Seleccione las personas que seran deseleccionadas.');
                                      }else{
                                              var pers = []
                                              ...
                                              $.ajax({
                                              url: CI.base_url + "convocatoria/capacitar/discapacitar_pers/",
                                              type:'POST',
                                              data:pers_data,
                                              dataType:'json',
                                              success:function(json){
