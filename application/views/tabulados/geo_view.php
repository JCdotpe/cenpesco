              ...
              $.ajax({
                  ...
                  success:function(json_data){
                      ...
                      $.each(json_data, function(i, data){
                        ...
                        sel.append('<div id="tiempo_desplazar"><input type="hidden" value="'+ data.t1_h +'" id="h1_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t2_h +'" id="h2_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t3_h +'" id="h3_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t4_h +'" id="h4_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t5_h +'" id="h5_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t6_h +'" id="h6_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t7_h +'" id="h7_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t8_h +'" id="h8_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t9_h +'" id="h9_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.total_h +'" id="ht_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> </div>');
                        $("#tiempo_desplazar").append('<input type="hidden" value="'+ data.t1_m +'" id="m1_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t2_m +'" id="m2_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t3_m +'" id="m3_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t4_m +'" id="m4_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t5_m +'" id="m5_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t6_m +'" id="m6_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t7_m +'" id="m7_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t8_m +'" id="m8_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.t9_m +'" id="m9_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" /> <input type="hidden" value="'+ data.total_m +'" id="mt_' + data.CCDD + data.CCPP + data.CCDI + data.CODCCPP + '" />');
                      });
                  }
              });   
