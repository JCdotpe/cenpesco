				...
				<!-- INICIO TABULADO -->
			    	<?php
				    	echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: EMBARCACIONES CON SISTEMA DE PROPULSIÓN A MOTOR, POR TIPO, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="4" style="text-align:center">Tipo de motor</th>';
									echo '<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>';																																														
									echo '</tr>';
									echo '<tr>';										
									echo '<th colspan="2" style="text-align:center">Marino</th>';																					
									echo '<th colspan="2" style="text-align:center">Automotriz</th>';																																																																																																																																																																																		
									echo '</tr>';
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Marino'		,"data" => $serie_1),
												array("name" => 'Automotriz'	,"data" => $serie_2),
