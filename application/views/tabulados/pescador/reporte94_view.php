				...
				<!-- INICIO TABULADO -->
			    	<?php
				    	echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: EMBARCACIONES PESQUERAS PROPIAS O AUTOCONSTRUIDAS, POR SISTEMA DE PROPULSIÓN DE LA EMBARCACIÓN, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="6" style="text-align:center">Sistema de propulsión de la embarcación</th>';	
									echo '<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>';																																													
									echo '</tr>';
									echo '<tr>';										
									echo '<th colspan="2" style="text-align:center">Remo</th>';																					
									echo '<th colspan="2" style="text-align:center">Vela</th>';																					
									echo '<th colspan="2" style="text-align:center">Motor</th>';																																																																																																																																																																																			
									echo '</tr>';
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Remo'		,"data" => $serie_1),
												array("name" => 'Vela'		,"data" => $serie_2),
												array("name" => 'Motor'		,"data" => $serie_3),
												array("name" => 'No especificado'		,"data" => $serie_4),
												); 
