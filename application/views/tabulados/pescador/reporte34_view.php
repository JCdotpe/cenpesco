			    	...
			    	<?php
				    		echo form_open("/tabulados/export");
								...
								echo '<thead>';
									...
									echo '<th colspan="10" style="text-align:center">Servicios de comunicación de la vivienda</th>';
									echo '<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>';																																														
									echo '</tr>';
									echo '<tr>';										
									echo '<th colspan="2" style="text-align:center">Teléfono fijo</th>';										
									echo '<th colspan="2" style="text-align:center">Teléfono celular</th>';											
									echo '<th colspan="2" style="text-align:center">Conexión a Internet</th>';											
									echo '<th colspan="2" style="text-align:center">Conexión a TV por cable</th>';											
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Teléfono fijo'				,"data" => $serie[0]),
												array("name" => 'Teléfono celular'			,"data" => $serie[1]),
												array("name" => 'Conexión a Internet'		,"data" => $serie[2]),
												array("name" => 'Conexión a tv por cable'	,"data" => $serie[3]),
												array("name" => 'Ninguno.'					,"data" => $serie[4]),
												array("name" => 'No especificado'						,"data" => $serie[5]),
												); 
