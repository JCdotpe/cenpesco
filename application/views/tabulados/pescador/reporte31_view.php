			    	...
			    	<?php
				    	echo form_open("/tabulados/export");
								...
								echo '<thead>';
									...
									echo '</tr>';
									echo '<tr>';										
									echo '<th colspan="2" style="text-align:center">Red pública de desagüe dentro de la vivienda</th>';										
									echo '<th colspan="2" style="text-align:center">Red pública de desagüe fuera de la vivienda, pero dentro de la edificación</th>';											
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Red pública de desagüe dentro de la vivienda'								,"data" => $serie[0]),
												array("name" => 'Red pública de desagüe fuera de la vivienda, pero dentro de la edificación',"data" => $serie[1]),
