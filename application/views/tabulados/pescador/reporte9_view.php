				...
				<!-- INICIO TABULADO -->
			    	<?php
				    	echo form_open("/tabulados/export");
								...
								echo '<div style="overflow:auto;"><table border="1" class="table table-striped box-header" id="tabul" >';
									echo '<caption><h3>
								...
								echo '<thead>';
									...
									echo '<tr>';
									echo '<th colspan="2" style="text-align:center">Hasta un año</th>';										
									echo '<th colspan="2" style="text-align:center">De 2 a 5 años</th>';
									echo '<th colspan="2" style="text-align:center">De 6 a 10 años</th>';										
									echo '<th colspan="2" style="text-align:center">Más de 10 años</th>';																												
									echo '</tr>';
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Hasta 1 año '		,"data" => $serie[0]),
												array("name" => 'De 2 a 5 años'		,"data" => $serie[1]),
												array("name" => 'De 6 a 10 años'	,"data" => $serie[2]),
												array("name" => 'Más de 10 años'	,"data" => $serie[3]),
