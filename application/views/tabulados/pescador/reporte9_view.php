...
<div class="row-fluid">
    <div class="span2">
 	...
 	<div class="span10" id="freg">
    	<h4>PERÚ: PESCADORES POR AÑOS DE DEDICACIÓN A LA ACTIVIDAD DE PESCA, SEGÚN DEPARTAMENTO, 2013</h4>
    	<?php
				echo '<table border="1" class="table table-hover table-condensed">';
					echo '<thead>';
						...
						echo '<th colspan="4" style="text-align:center">Años de dedicación a la actividad de pesca</th>';																																														
						echo '</tr>';
						echo '<tr>';
						echo '<th></th>';										
						echo '<th></th>';										
