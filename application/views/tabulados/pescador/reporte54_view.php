			    	...
			    	<?php
				    		echo form_open("/tabulados/export");
								...
								echo '<thead>';
									...
									echo '<th colspan="8" style="text-align:center">Lugar de desembarque</th>';
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Puerto'							,"data" => $serie[0]),
												array("name" => 'Playa'								,"data" => $serie[1]),
												array("name" => 'Desembarcadero pesquero artesanal'	,"data" => $serie[2]),
