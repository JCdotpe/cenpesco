				...
				<!-- INICIO TABULADO -->
			    	<?php
				    	echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: PESCADORES POR TIPO DE DIFICULTAD O LIMITACIÓN PERMANENTE, SEGÚN DEPARTAMENTO, 2013';
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Para ver, aún usando lentes'						,"data" => $serie[0]),
												array("name" => 'Para oír, aún usando audífonos para sordera'		,"data" => $serie[1]),
												array("name" => 'Para hablar (entonar / vocalizar)'					,"data" => $serie[2]),
												array("name" => 'Para usar brazos y manos / piernas y pies'			,"data" => $serie[3]),
												array("name" => 'Alguna otra dificultad o limitación.'				,"data" => $serie[4]),
												array("name" => 'Ninguna.'											,"data" => $serie[5]),
												array("name" => 'No especificado'												,"data" => $serie[6]),
												); 
