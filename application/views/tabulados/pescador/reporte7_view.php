				...
				<!-- INICIO TABULADO -->
			    	<?php
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: PESCADORES POR ACTIVIDAD ADICIONAL QUE REALIZA, SEGÚN DEPARTAMENTO, 2013';
					...
					<?php 
						...
						$series = array(
										array("name" => 'Agrícola '					,"data" => $serie[0]),
										array("name" => 'Pecuaria'					,"data" => $serie[1]),
										array("name" => 'Acuícola'					,"data" => $serie[2]),
										array("name" => 'Caza'						,"data" => $serie[3]),
										array("name" => 'Construcción'				,"data" => $serie[4]),
										array("name" => 'Comercio'					,"data" => $serie[5]),
										array("name" => 'Otro'						,"data" => $serie[6]),
										array("name" => 'No tiene otra Actividad'	,"data" => $serie[7]),
