...
<div class="row-fluid">
    <div id="ap-sidebar" class="span2">
 	...
 	<div class="span10" id="ap-content">
    	<h4>PERÚ: BOTES DE PESCA ARTESANAL O COMERCIAL, POR TENENCIA DE NÚMERO DE MATRÍCULA, SEGÚN DEPARTAMENTO, 2013</h4>
    	<?php
				echo '<table border="1" class="table table-hover table-condensed" id="tabul">';
					echo '<thead>';
						...
						echo '<th colspan="10" style="text-align:center">Tiene número de matrícula</th>';																																														
						echo '</tr>';
						echo '<tr>';
						echo '<th></th>';										
						echo '<th></th>';										
