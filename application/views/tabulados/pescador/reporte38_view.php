				...
				<!-- INICIO TABULADO -->
			    	<?php
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: PESCADORES POR TIPO DE SEGURO DE SALUD QUE CONOCE, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">Tipo de seguro de salud que conoce</th>';
									echo ($NEP>0) ? ('<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>'): '';																																														
									echo '</tr>';
									echo '<tr>';
										echo '<th colspan="2" style="text-align:center">'. ($variable_1 = 'Régimen especial de seguro médico del pescador en EsSalud') .'</th>';										
										echo '<th colspan="2" style="text-align:center">'. ($variable_2 = 'Seguro Integral de Salud' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_3 = 'Entidad Prestadora de Salud' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_4 = 'Seguro Social de Salud (EsSalud)' ) .'</th>';																						
