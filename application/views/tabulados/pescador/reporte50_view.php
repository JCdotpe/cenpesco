			    	...
			    	<?php
				    		echo form_open("/tabulados/export");
								...
								echo '<thead>';
									...
									echo '<th colspan="10" style="text-align:center">Tipo de aparejos</th>';
									echo '<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>';																																														
									echo '</tr>';
									echo '<tr>';										
									echo '<th colspan="2" style="text-align:center">Líneas y anzuelos</th>';										
									echo '<th colspan="2" style="text-align:center">Arpón</th>';																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																												
									echo '<th colspan="2" style="text-align:center">Farpa</th>';																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																												
									echo '<th colspan="2" style="text-align:center">Espineles</th>';																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																												
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Líneas y anzuelos'	,"data" => $serie[0]),
												array("name" => 'Arpón'				,"data" => $serie[1]),
												array("name" => 'Farpa'				,"data" => $serie[2]),
												array("name" => 'Espineles'			,"data" => $serie[3]),
												array("name" => 'Otro'				,"data" => $serie[4]),
												); 
