			    	...
			    	<?php
				    	echo form_open("/tabulados/export");
								...
								echo '<thead>';
									...
									echo '<th colspan="14" style="text-align:center">Material predominante en los pisos de la vivienda</th>';
									echo '<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>';																																													
									echo '</tr>';
									echo '<tr>';									
									echo '<th colspan="2" style="text-align:center">Parquet o madera pulida</th>';										
									echo '<th colspan="2" style="text-align:center">Láminas asfálticas, vinilicos o similares</th>';											
									echo '<th colspan="2" style="text-align:center">Losetas, terrazos o similares</th>';											
									echo '<th colspan="2" style="text-align:center">Madera (entablados)</th>';											
									echo '<th colspan="2" style="text-align:center">Cemento</th>';											
									echo '<th colspan="2" style="text-align:center">Tierra</th>';																																										
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Parquet o madera pulida'					,"data" => $serie[0]),
												array("name" => 'Láminas asfálticas, vinilicos o similares'	,"data" => $serie[1]),
												array("name" => 'Losetas, terrazos o similares'				,"data" => $serie[2]),
												array("name" => 'Madera (entablados)'						,"data" => $serie[3]),
												array("name" => 'Cemento'									,"data" => $serie[4]),
												array("name" => 'Tierra'									,"data" => $serie[5]),
												array("name" => 'Otro material'								,"data" => $serie[6]),
												array("name" => 'No especificado'										,"data" => $serie[7]),
												); 
