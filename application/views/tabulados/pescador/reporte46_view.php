...
<div class="row-fluid">
    <div class="span2">
 	...
 	<div class="span10" id="freg">
    	<h4>PERÚ: PESCADORES POR LUGAR DONDE SE ENCUENTRA SU ZONA DE PESCA, SEGÚN DEPARTAMENTO, 2013</h4>
    	<?php
				echo '<table border="1" class="table table-hover table-condensed">';
					echo '<thead>';
						...
						echo '<th colspan="16" style="text-align:center">Lugar donde se encuentra su zona de pesca</th>';																																														
						echo '</tr>';
						echo '<tr>';
						echo '<th></th>';										
						echo '<th></th>';										
