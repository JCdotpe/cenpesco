				...
				<!-- INICIO TABULADO -->
			    	<?php
				    	echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: PESCADORES POR USO DE ALGÚN ESPACIO DE LA VIVIENDA PARA REALIZAR ALGUNA ACTIVIDAD QUE PROPORCIONE OTROS INGRESOS, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="4" style="text-align:center">Uso de algún espacio de la vivienda para realizar alguna actividad que proporcione otros ingresos</th>';
									echo '<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>';																																													
									echo '</tr>';
									echo '<tr>';										
									echo '<th colspan="2" style="text-align:center">Si utiliza</th>';										
									echo '<th colspan="2" style="text-align:center">No utiliza</th>';																																																													
									echo '</tr>';
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Si utiliza'	,"data" => $serie[0]),
												array("name" => 'No utiliza'	,"data" => $serie[1]),
