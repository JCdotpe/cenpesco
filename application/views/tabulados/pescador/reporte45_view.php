				...
				<!-- INICIO TABULADO -->
			    	<?php
				    	echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: PESCADORES POR FUENTES HÍDRICAS DONDE REALIZAN LA EXTRACCIÓN DE ESPECIES HIDROBIOLÓGICAS, SEGÚN DEPARTAMENTO, 2013';
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Río'			,"data" => $serie[0]),
												array("name" => 'Lago'			,"data" => $serie[1]),
												array("name" => 'Laguna'		,"data" => $serie[2]),
												array("name" => 'Marisma'		,"data" => $serie[3]),
												array("name" => 'Quebrada'		,"data" => $serie[4]),
												array("name" => 'Cocha'			,"data" => $serie[5]),
												array("name" => 'Reservorio'	,"data" => $serie[6]),
