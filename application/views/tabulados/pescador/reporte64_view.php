				...
				<!-- INICIO TABULADO -->
			    	<?php	
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: PESCADORES QUE TIENEN PERMISO PARA DESARROLLAR SU ACTIVIDAD, POR VIGENCIA DEL DOCUMENTO, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">El permiso para desarrollar la actividad de pesca se encuentra vigente</th>';
