...
<div class="row-fluid">
    <div id="ap-sidebar" class="span2">
 	...
 	<div class="span10" id="ap-content">
    	<h4>PERÚ: HIJOS DE PESCADORES POR NIVEL DE ESTUDIOS ALCANZADO, SEGÚN DEPARTAMENTO, 2013</h4>
    	<?php
					...
					echo '<thead>';
						...
						foreach($dep->result() as $d){
							...
							echo '<td style="text-align:center;color:green">' . round($td[$d->CCDD]*100/$ttt,2) . '%</td>';	
								...
								echo '<td style="text-align:center;color:green">' . round($e10[$d->CCDD]*100/$ttt,2) . '%</td>';																										
							echo '</tr>';
