 	...
 	<div class="span10" id="ap-content">
    	...
    	<?php
	    		echo form_open("/tabulados/export");
	    			$c_title = 'PERÚ: PESCADORES POR PROGRAMAS SOCIALES QUE HAN BENEFICIADO SU HOGAR, SEGÚN DEPARTAMENTO, 2013';
					...
					echo '<thead>';
						...
						echo '<th colspan="18" style="text-align:center">Programas sociales que han beneficiado su hogar</th>';
						...
						echo '<th colspan="2" style="text-align:center">Desayuno o alimentación escolar (Qali warma)</th>';																					
		...
		<?php 
			...
			$series = array(
							array("name" => 'Vaso de leche'		,"data" => $serie[0]),
							array("name" => 'Comedor popular'	,"data" => $serie[1]),
							array("name" => 'Qali warma'		,"data" => $serie[2]),
							array("name" => 'SIS'				,"data" => $serie[3]),
							array("name" => 'Programa Juntos'	,"data" => $serie[4]),
							array("name" => 'Pensión 65'		,"data" => $serie[5]),
							array("name" => 'Programa Cuna Más'	,"data" => $serie[6]),
							array("name" => 'Otro'				,"data" => $serie[7]),
							array("name" => 'Ninguno'			,"data" => $serie[8]),
