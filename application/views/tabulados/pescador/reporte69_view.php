				...
				<!-- INICIO TABULADO -->
			    	<?php
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: PESCADORES POR GANANCIA NETA PROMEDIO MENSUAL, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">Ganancia neta promedio mensual</th>';
									echo ($NEP>0) ? ('<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>'): '';																																														
									echo '</tr>';
									echo '<tr>';	
										echo '<th colspan="2" style="text-align:center">'. ($variable_1 = 'Hasta S/. 500') .'</th>';										
										echo '<th colspan="2" style="text-align:center">'. ($variable_2 = 'Desde S/. 501 hasta S/. 1,000' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_3 = 'Desde S/. 1,001 hasta S/. 2,000' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_4 = 'Desde S/. 2,001 hasta S/. 3,000' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_5 = 'Más de S/. 3,000' ) .'</th>';						
									echo '</tr>';
