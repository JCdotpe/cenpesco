				...
				<!-- INICIO TABULADO -->
			    	<?php
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: PESCADORES POR DESTINO DE LA PRODUCCIÓN ANUAL DE SU PESCA, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';											
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">Destino de la producción anual de la pesca </th>';
