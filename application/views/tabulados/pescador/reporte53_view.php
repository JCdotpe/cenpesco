				...
				<!-- INICIO TABULADO -->
			    	<?php
				    	echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: PESCADORES POR SU CONDICIÓN, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="4" style="text-align:center">Condición del pescador</th>';	
									echo '<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>';																																													
									echo '</tr>';
									echo '<tr>';										
									echo '<th colspan="2" style="text-align:center">Embarcado</th>';										
									echo '<th colspan="2" style="text-align:center">No embarcado</th>';																																																																																																																																																																																																																																															
									echo '</tr>';
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Embarcado'		,"data" => $serie[0]),
												array("name" => 'No embarcado'	,"data" => $serie[1]),
