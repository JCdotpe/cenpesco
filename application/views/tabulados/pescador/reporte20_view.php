...
<div class="row-fluid">
    <div id="ap-sidebar" class="span2">
 	...
 	<div class="span10" id="ap-content">
    	<h4>PERÚ: HIJOS DE PESCADORES QUE TIENEN ALGÚN TIPO DE DIFICULTAD O LIMITACIÓN PERMANENTE PARA DESARROLLAR SUS ACTIVIDADES DIARIAS, SEGÚN DEPARTAMENTO, 2013</h4>
    	<?php
				echo '<table border="1" class="table table-hover table-condensed" id="tabul">';
					echo '<thead>';
						...
						echo '<th colspan="16" style="text-align:center">Tiene algún tipo de dificultad o limitación permanente para desarrollar sus actividades diarias</th>';																																														
						echo '</tr>';
						echo '<tr>';
						echo '<th></th>';										
						echo '<th></th>';										
