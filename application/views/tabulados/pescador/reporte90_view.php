			    	...
			    	<?php
				    	echo form_open("/tabulados/export");
								...
								echo '<thead>';
									...
									echo '<th colspan="2" style="text-align:center">Cada 6 meses</th>';																					
									echo '<th colspan="2" style="text-align:center">Cada año</th>';																					
									echo '<th colspan="2" style="text-align:center">Cada dos años</th>';																																																																																																																																																															
									echo '<th colspan="2" style="text-align:center">Cada tres años</th>';																																																																																																																																																															
									echo '</tr>';
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Cada 3 meses'		,"data" => $serie_1),
												array("name" => 'Cada 6 meses'		,"data" => $serie_2),
												array("name" => 'Cada año'			,"data" => $serie_3),
												array("name" => 'Cada dos años'		,"data" => $serie_4),
												array("name" => 'Cada tres años'	,"data" => $serie_5),
