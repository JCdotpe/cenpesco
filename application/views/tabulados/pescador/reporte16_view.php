								...
								echo '<tbody>';									
									...
									foreach($dep->result() as $d){
										...
										echo '<td style="text-align:center;">' . number_format( ( ($td[$d->CCDD]>0) ? 100 : 0 ),1,',',' ') . '</td>';	
											...
											echo '<td style="text-align:center">' . number_format($male[$d->CCDD],0,',',' ') . '</td>';										
											echo '<td style="text-align:center;">' . number_format(( $serie_1[] = round($male[$d->CCDD]*100/$td[$d->CCDD],1) ),1,',',' ') . '</td>';	

											echo '<td style="text-align:center">' . number_format($female[$d->CCDD],0,',',' ') . '</td>';										
											echo '<td style="text-align:center;">' . number_format(( $serie_2[] = round($female[$d->CCDD]*100/$td[$d->CCDD],1) ),1,',',' ') . '</td>';

											echo '<td style="text-align:center">' . number_format($NEP[$d->CCDD],0,',',' ') . '</td>';										
											echo '<td style="text-align:center;">' . number_format(( $serie_NEP[] = round($NEP[$d->CCDD]*100/$td[$d->CCDD],1) ),1,',',' ') . '</td>';									
										echo '</tr>';
									...
									echo '<td style="text-align:center;">100,0</td>';	
											...
											echo '<td style="text-align:center">' . number_format($tm,0,',',' ') . '</td>';										
											echo '<td style="text-align:center;">' . number_format((round($tm*100/$ttt,1)),1,',',' ') . '</td>';	

											echo '<td style="text-align:center">' . number_format($tf,0,',',' ') . '</td>';										
											echo '<td style="text-align:center;">' . number_format((round($tf*100/$ttt,1)),1,',',' ') . '</td>';

											echo '<td style="text-align:center">' . number_format($tNEP,0,',',' ') . '</td>';										
											echo '<td style="text-align:center;">' . number_format((round($tNEP*100/$ttt,1)),1,',',' ') . '</td>';			
									echo '</tr>';
