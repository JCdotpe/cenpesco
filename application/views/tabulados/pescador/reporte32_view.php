...
<div class="row-fluid">
    <div class="span2">
 	...
 	<div class="span10" id="freg">
    	<h4>PERÚ: PESCADORES POR TENENCIA DE ALUMBRADO ELÉCTRICO, SEGÚN DEPARTAMENTO, 2013</h4>
    	<?php
				echo '<table border="1" class="table table-hover table-condensed">';
					echo '<thead>';
						...
						echo '<th colspan="14" style="text-align:center">Tenencia de alumbrado eléctrico</th>';																																														
						echo '</tr>';
						echo '<tr>';
						echo '<th></th>';										
						echo '<th></th>';										
