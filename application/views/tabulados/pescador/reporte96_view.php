				...
				<!-- INICIO TABULADO -->
			    	<?php
				    	echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: EMBARCACIONES CON SISTEMA DE PROPULSIÓN A MOTOR, POR TIPO DE COMBUSTIBLE QUE UTILIZA, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="4" style="text-align:center">Tipo de combustible</th>';
									echo '<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>';																																														
									echo '</tr>';
									echo '<tr>';										
									echo '<th colspan="2" style="text-align:center">Gasolina</th>';																					
									echo '<th colspan="2" style="text-align:center">Petróleo</th>';																																																																																																																																																																																		
									echo '</tr>';
						...
						$series = array(
										array("name" => 'Gasolina'		,"data" => $serie_1),
										array("name" => 'Petróleo'		,"data" => $serie_2),
