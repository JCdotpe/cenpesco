			    	...
			    	<?php	
				    		...
				    		echo form_open("/tabulados/export");
								...
								echo '<thead>';
									...
									echo '</tr>';
									echo '<tr>';									
									echo '<th colspan="2" style="text-align:center">'. ($variable_1 = 'Dentro de su comunidad') .'</th>';										
									echo '<th colspan="2" style="text-align:center">'. ($variable_2 = 'Fuera de su comunidad' ) .'</th>';						
									echo '</tr>';
