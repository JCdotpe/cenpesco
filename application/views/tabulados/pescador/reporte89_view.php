			    	...
			    	<?php
				    	echo form_open("/tabulados/export");
								...
								echo '<thead>';
									...
									echo '<th colspan="8" style="text-align:center">Estado de la embarcación</th>';	
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Operativa'							,"data" => $serie_1),
												array("name" => 'En reparación'						,"data" => $serie_2),
												array("name" => 'En abandono'						,"data" => $serie_3),
												array("name" => 'En construcción o reconstrucción'	,"data" => $serie_4),
