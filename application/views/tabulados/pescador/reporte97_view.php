			    	...
			    	<?php
				    	echo form_open("/tabulados/export");
								...
								echo '<thead>';
									...
									echo '<th colspan="8" style="text-align:center">Tipo de bodega</th>';	
									echo '<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>';																																													
									echo '</tr>';
									echo '<tr>';										
									echo '<th colspan="2" style="text-align:center">Abierto</th>';																					
									echo '<th colspan="2" style="text-align:center">Tabicado abierto</th>';																					
									echo '<th colspan="2" style="text-align:center">Tabicado con tapa</th>';																					
									echo '<th colspan="2" style="text-align:center">Con cajón simple</th>';																																																																																																																																																																																																																																																																																																																													
									echo '</tr>';
							...
							echo '</table></div>';
								...
								$series = array(
												array("name" => 'Abierto'			,"data" => $serie_1),
												array("name" => 'Tabicado abierto'	,"data" => $serie_2),
												array("name" => 'Tabicado con tapa'	,"data" => $serie_3),
												array("name" => 'Con cajón simple'	,"data" => $serie_4),
												array("name" => 'No especificado'				,"data" => $serie_5),
												); 
