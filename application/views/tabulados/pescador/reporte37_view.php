   ...
   <div id="ap-sidebar" class="span2">
 	...
 	<div class="span10" id="ap-content">
		...
		<?php 
			...
			$series = array(
							array("name" => 'Régimen especial de seguro médico del pescador en EsSalud'	,"data" => $serie[0]),
							array("name" => 'Seguro Integral de Salud'									,"data" => $serie[1]),
							array("name" => 'Entidad Prestadora de Salud'								,"data" => $serie[2]),
