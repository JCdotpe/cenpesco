    ...
    <div id="ap-sidebar" class="span2">
 	...
 	<div class="span10" id="ap-content">
    	...
    	<?php
	    		echo form_open("/tabulados/export");
					...
					echo '<thead>';
						...
						echo '<th colspan="6" style="text-align:center">Energía alternativa</th>';	
						echo '<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">NEP</th>';																																													
						echo '</tr>';

						echo '<tr>';
						echo '<th colspan="2" style="text-align:center">Biodigestor</th>';										
					...
					echo '<tbody>';
						...
						foreach($tables->result() as $reg){
							...
							$tot = $reg->TOTAL;
							$serie_1[] = round(($a = $reg->BIODIGESTOR)*100/$tot,2);
							$serie_2[] = round(($b = $reg->PANEL)*100/$tot,2);
							$serie_3[] = round(($c = $reg->NINGUNA)*100/$tot,2);
							$serie_4[] = round(($d = $reg->NEP)*100/$tot,2);
		...
		<?php 
			...
			$series = array(
							array("name" => 'BIODIGESTOR'	,"data" => $serie_1),
							array("name" => 'PANEL'			,"data" => $serie_2),
							array("name" => 'NINGUNA'		,"data" => $serie_3),
