...
<table id="tab_meta" name="tab_meta" >
	<tr>
...
<div class="row-fluid"  style="padding-bottom:10px;padding-top:7px" >
	...
	<input type="button" class="btn btn-primary pull-right" id="btn_metadata" name="btn_metadata" value="Guardar" name="guardar">
...
$(function(){
		...
		$('#btn_metadata').click(function() {
			        ...
			        $.ajax({
			            url: CI.base_url + "tabulados/comunidad/metadata",
			            type:'POST',
			            data:t_data,
			            success:function(){
