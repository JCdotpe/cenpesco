...
<div class="row-fluid">
    <div id="ap-sidebar" class="span2">
 	...
 	<div class="span10" id="ap-content">
    	<h4 style="text-align:center">CUADRO N° 236</h4>
    	<h4 style="text-align:center">PERÚ: COMUNIDADES POR ESTRATEGIAS QUE SE HAN IMPLEMENTADO PARA AFRONTAR LOS PROBLEMAS QUE DIFICULTAN EL DESARROLLO DE LA ACTIVIDAD DE PESCA Y/O ACUICULTURA, SEGÚN DEPARTAMENTO, 2013</h4>
    	<?php
