				...
				echo '<table border="1" class="table table-hover table-condensed">';
					...
					echo '<tbody>';
						...
						foreach($tables->result_array() as $reg){
							...
							echo '<td style="text-align:center;color:green">' . round($t*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $u. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($u*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $v . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($v*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $w. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($w*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $x . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($x*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $y. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($y*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $z. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($z*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $aa . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($aa*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $ab. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($ab*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $ac . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($ac*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $ad. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($ad*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $ae . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($ae*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $af. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($af*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $ag . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($ag*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $ah. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($ah*100/$tot_tot,2) . '%</td>';
							echo '<td style="text-align:center">' . $ai . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($ai*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $aj. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($aj*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $ak . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($ak*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $al. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($al*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $am . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($am*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $an. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($an*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $ao . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($ao*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $ap. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($ap*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $aq . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($aq*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $ar. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($ar*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $as . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($as*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $at. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($at*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $au . '</td>';										
							echo '<td style="text-align:center;color:green">' . round($au*100/$tot_tot,2) . '%</td>';	
							echo '<td style="text-align:center">' . $av. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($av*100/$tot_tot,2) . '%</td>';
							echo '<td style="text-align:center">' . $aw. '</td>';										
							echo '<td style="text-align:center;color:green">' . round($aw*100/$tot_tot,2) . '%</td>';																																																																																							
							echo '</tr>';
