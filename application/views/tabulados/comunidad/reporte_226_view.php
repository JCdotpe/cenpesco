...
<div class="row-fluid">
    <div id="ap-sidebar" class="span2">
 	...
 	<div class="span10" id="ap-content">
    	<h4 style="text-align:center">CUADRO N° 226</h4>
    	<h4 style="text-align:center">PERÚ: COMUNIDADES POR EXISTENCIA DE ASOCIACIONES U ORGANIZACIONES, SEGÚN DEPARTAMENTO, 2013</h4>
    	<?php
