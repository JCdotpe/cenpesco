    ...
    <div id="ap-sidebar" class="span2">
 	...
 	<div class="span10" id="ap-content">
	    		...
	    		echo form_open("/tabulados/export");
					...
					echo '<tbody>';
						...
						foreach($tables->result() as $reg){
							...
							$tot = $reg->TOTAL;
							$serie_1[] = round(($a = $reg->RELLENO)*100/$tot);
							$serie_2[] = round(($b = $reg->BOTADERO)*100/$tot);
							$serie_3[] = round(($c = $reg->VERTIDOS)*100/$tot);
							$serie_4[] = round(($d = $reg->RECICLAJE)*100/$tot);
							$serie_5[] = round(($e = $reg->QUEMADA)*100/$tot);
							$serie_6[] = round(($f = $reg->OTRO)*100/$tot);
							$serie_7[] = round(($g = $reg->NEP)*100/$tot);
		...
		<?php 
			...
			$series = array(
							array("name" => 'RELLENO'	,"data" => $serie_1),
							array("name" => 'BOTADERO'	,"data" => $serie_2),
							array("name" => 'VERTIDOS'	,"data" => $serie_3),
							array("name" => 'RECICLAJE'	,"data" => $serie_4),
							array("name" => 'QUEMADA'	,"data" => $serie_5),
