 	...
 	<div class="span10" id="ap-content">
    	...
    	<?php
	    		echo form_open("/tabulados/export");
					...
					echo '<thead>';
						...
						echo '<th colspan="10" style="text-align:center">Destino final de los desagües</th>';	
						...
						echo '<th colspan="2" style="text-align:center">Bosque, monte</th>';						
						echo '<th colspan="2" style="text-align:center">Laguna de oxidación</th>';						
						echo '<th colspan="2" style="text-align:center">Canal, acequia</th>';						
					...
					echo '<tbody>';
						...
						foreach($tables->result() as $reg){
							...
							$serie_2[] = round(($b = $reg->BOSQUE)*100/$tot,2);
							$serie_3[] = round(($c = $reg->LAGUNA)*100/$tot,2);
							$serie_4[] = round(($d = $reg->CANAL)*100/$tot,2);
		...
		<?php 
			...
			$series = array(
							...
							array("name" => 'BOSQUE'	,"data" => $serie_2),
							array("name" => 'LAGUNA'	,"data" => $serie_3),
							array("name" => 'CANAL'		,"data" => $serie_4),
