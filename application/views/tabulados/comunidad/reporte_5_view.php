...
<div class="row-fluid">
    <div id="ap-sidebar" class="span2">
 	...
 	<div class="span10" id="ap-content">
    	<h4 style="text-align:center">CUADRO N° 204</h4>
    	<h4 style="text-align:center">PERÚ: COMUNIDADES POR TIPO DE ENERGÍA ALTERNATIVA CON LA QUE CUENTAN, SEGÚN DEPARTAMENTO, 2013</h4>
    	<?php
