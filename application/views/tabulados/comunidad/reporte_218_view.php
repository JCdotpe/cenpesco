			    	...
			    	<?php
				    		...
				    		echo form_open("/tabulados/export");
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">Tipo de violencia</th>';	
									echo ($NEP>0) ? ('<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>'): '';																																														
									echo '</tr>';
									echo '<tr>';		
										echo '<th colspan="2" style="text-align:center">'. ($variable_1 = 'Violencia doméstica (Contra mujeres, niños, ancianos)') .'</th>';										
										echo '<th colspan="2" style="text-align:center">'. ($variable_2 = 'Violencia sexual' ) .'</th>';																				
										echo '<th colspan="2" style="text-align:center">'. ($variable_3 = 'Asaltos, robos' ) .'</th>';																				
										echo '<th colspan="2" style="text-align:center">'. ($variable_4 = 'Otro' ) .'</th>';									
										echo '<th colspan="2" style="text-align:center">'. ($variable_5 = 'Ninguna' ) .'</th>';									
									echo '</tr>';
									echo '<tr>';
											for ($i=1; $i <=$cant_v ; $i++) { 
