...
<div class="row-fluid">
    <div id="ap-sidebar" class="span2">
 	...
 	<div class="span10" id="ap-content">
    	<h4 style="text-align:center">CUADRO N° 233</h4>
    	<h4 style="text-align:center">PERÚ: COMUNIDADES QUE REALIZAN LA PESCA POR TÉCNICAS QUE SE UTILIZAN EN LA ACTIVIDAD DIFERENTES A LAS TRADICIONALES, SEGÚN DEPARTAMENTO, 2013</h4>
    	<?php
