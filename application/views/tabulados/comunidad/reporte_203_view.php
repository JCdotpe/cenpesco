    ...
    <div id="ap-sidebar" class="span2">
 	...
 	<div class="span10" id="ap-content">
    	...
    	<?php
	    		echo form_open("/tabulados/export");
					...
					echo '<thead>';
						...
						echo '<th colspan="8" style="text-align:center">Razones que consideran deficiente el servicio de energía eléctrica</th>';	
					...
					echo '<tbody>';
						...
						foreach($tables->result() as $reg){
							...
							$tot = $reg->TOTAL;
							$serie_1[] = round(($a = $reg->INTERRUPCION)*100/$tot,2);
							$serie_2[] = round(($b = $reg->RESTRINGIDO)*100/$tot,2);
							$serie_3[] = round(($c = $reg->COSTO)*100/$tot,2);
							$serie_4[] = round(($d = $reg->OTRA)*100/$tot,2);
		...
		<?php 
			...
			$series = array(
							array("name" => 'INTERRUPCION'	,"data" => $serie_1),
							array("name" => 'RESTRINGIDO'	,"data" => $serie_2),
							array("name" => 'COSTO'			,"data" => $serie_3),	
							array("name" => 'OTRA'			,"data" => $serie_4),	
