 	...
 	<div class="span10" id="ap-content">
    	...
    	<?php
	    		echo form_open("/tabulados/export");
	    			$c_title = 'PERÚ: COMUNIDADES POR TIPO DE CONTAMINACIÓN AMBIENTAL QUE EXISTE, SEGÚN DEPARTAMENTO, 2013';
					...
					echo '<thead>';
						...
						echo '<th colspan="10" style="text-align:center">Tipo de contaminación ambiental</th>';
						echo '<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">NEP</th>';																																														
						echo '</tr>';
									
						echo '<tr>';
						echo '<th colspan="2" style="text-align:center">Contaminación del río, lago, etc.</th>';										
						echo '<th colspan="2" style="text-align:center">Contaminación del suelo</th>';						
						echo '<th colspan="2" style="text-align:center">Contaminación del aire</th>';						
						echo '<th colspan="2" style="text-align:center">Contaminación acústica</th>';						
					...
					echo '<tbody>';
						...
						foreach($tables->result() as $reg){
							...
							$serie_2[] = round(($b = $reg->SUELO)*100/$tot,2);
							$serie_3[] = round(($c = $reg->AIRE)*100/$tot,2);
							$serie_4[] = round(($d = $reg->ACUSTICA)*100/$tot,2);
		...
		<?php 
			...
			$series = array(
							array("name" => 'RIO'		,"data" => $serie_1),
							array("name" => 'SUELO'		,"data" => $serie_2),
							array("name" => 'AIRE'		,"data" => $serie_3),
							array("name" => 'ACUSTICA'	,"data" => $serie_4),
