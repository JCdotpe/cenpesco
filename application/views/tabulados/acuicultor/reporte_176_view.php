				...
				<!-- INICIO TABULADO -->
			    	<?php
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: ACUICULTORES POR INGRESO PROMEDIO MENSUAL, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">Ingreso promedio mensual</th>';
									echo ($NEP>0) ? ('<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>'): '';																																														
									echo '</tr>';
									echo '<tr>';	
										echo '<th colspan="2" style="text-align:center">'. ($variable_1 = 'Hasta S/. 2,000') .'</th>';										
										echo '<th colspan="2" style="text-align:center">'. ($variable_2 = 'Desde S/. 2,001 hasta S/. 5,000' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_3 = 'Desde S/. 5,001 hasta S/. 10,000' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_4 = 'Desde S/. 10,001 hasta S/. 20,000' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_5 = 'Más de S/. 20,000' ) .'</th>';						
									echo '</tr>';
					...
					<?php 
						...
						if ($NEP > 0) { array_push( $series, array("name" => 'No especificado'	,"data" => $datas[5]) ); }
