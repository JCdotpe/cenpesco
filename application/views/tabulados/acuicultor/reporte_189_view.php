				...
				<!-- INICIO TABULADO -->
			    	<?php
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: ACUICULTORES QUE RECIBIERON CAPACITACIÓN, POR INSTITUCIÓN QUE LA BRINDÓ, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<tr>';																					
										...
										echo '<th colspan="2" style="text-align:center">'. ($variable_10 = 'Empresa Privada' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_11 = 'Gobierno Local' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_12 = 'Ministerio de Agricultura' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_13 = 'Universidades' ) .'</th>';						
