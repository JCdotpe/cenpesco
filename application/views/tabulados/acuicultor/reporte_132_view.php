				...
				<!-- INICIO TABULADO -->
			    	<?php 
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: ACUICULTORES QUE SE ABASTECEN DE AGUA POTABLE, POR TENENCIA DE AGUA TODOS LOS DÍAS DE LA SEMANA, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">Tenencia de agua todos los días de la semana</th>';
