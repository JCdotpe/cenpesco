				...
				<!-- INICIO TABULADO -->
			    	<?php
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: ACUICULTORES POR MEDIO DE TRANSPORTE QUE UTILIZA GENERALMENTE PARA TRASLADARSE DESDE SU VIVIENDA AL CENTRO DE CULTIVO, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">Medio de transporte</th>';
									echo ($NEP>0) ? ('<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>'): '';																																														
									echo '</tr>';
									echo '<tr>';
										echo '<th colspan="2" style="text-align:center">'. ($variable_1 = 'A pie') .'</th>';										
										echo '<th colspan="2" style="text-align:center">'. ($variable_2 = 'Acémila' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_3 = 'Moto, mototaxi, etc.' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_4 = 'Auto, camioneta, etc.' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_5 = 'Camioneta rural, ómnibus, etc' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_6 = 'Bote, lancha, etc. (acuático con motor)' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_7 = 'Canoa, balsa, etc. (Acuático sin motor)' ) .'</th>';						
					...
					<?php 
						...
						if ($NEP > 0) { array_push( $series, array("name" => 'No especificado'	,"data" => $datas[8]) ); }
