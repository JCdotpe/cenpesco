				...
				<!-- INICIO TABULADO -->
			    	<?php
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: ACUICULTORES POR RAZÓN POR LA QUE ELIGIÓ DESARROLLAR ESTA ACTIVIDAD, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="8" style="text-align:center">Razón  por lo que eligió ser acuicultor</th>';
