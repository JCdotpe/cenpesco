				...
				<!-- INICIO TABULADO -->
			    	<?php
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: ACUICULTORES POR TIPO DE INSTALACIONES QUE UTILIZA EN SU ACTIVIDAD, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">Tipo de instalaciones</th>';
									echo ($NEP>0) ? ('<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>'): '';																																														
									echo '</tr>';
									echo '<tr>';	
										echo '<th colspan="2" style="text-align:center">'. ($variable_1 = 'Estanques naturales') .'</th>';										
										echo '<th colspan="2" style="text-align:center">'. ($variable_2 = 'Estanques artificiales' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_3 = 'Jaulas flotantes artesanales' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_4 = 'Jaulas flotantes metálicas	' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_5 = 'Tanques' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_6 = 'Artesas' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_7 = 'Incubadoras' ) .'</th>';						
