				...
				<!-- INICIO TABULADO -->
			    	<?php
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: ACUICULTORES POR TIPO DE CULTIVO, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">Tipo de cultivo</th>';
									echo ($NEP>0) ? ('<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>'): '';																																														
									echo '</tr>';
									echo '<tr>';	
										echo '<th colspan="2" style="text-align:center">'. ($variable_1 = 'Monocultivo') .'</th>';										
										echo '<th colspan="2" style="text-align:center">'. ($variable_2 = 'Policultivo' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_3 = 'Cultivo asociado' ) .'</th>';						
									echo '</tr>';
