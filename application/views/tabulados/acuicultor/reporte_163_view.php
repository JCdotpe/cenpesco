				...
				<!-- INICIO TABULADO -->
			    	<?php
				    		...
				    		echo form_open("/tabulados/export");
				    			$c_title = 'PERÚ: ACUICULTORES QUE TIENEN TRABAJADORES CON ALGUNA DIFICULTAD O LIMITACIÓN PERMANENTE PARA DESEMPEÑAR SUS LABORES, SEGÚN DEPARTAMENTO, 2013';
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">Trabajadores que tienen alguna dificultad o limitación permanente para desempeñar sus labores</th>';
