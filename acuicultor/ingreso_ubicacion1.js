...
var distrito;
document.getElementById("S2_9_PP").value=document.getElementById("S2_9_PP_COD").options[document.getElementById("S2_9_PP_COD").selectedIndex].text;
...
ajax.open("GET", "distrito_uproceso.php?codprov="+codprov+"&coddep="+coddep,true);
