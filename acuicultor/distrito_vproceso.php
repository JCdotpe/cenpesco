...
echo '<select name="S2_11_DI_COD" id="S2_11_DI_COD" onchange="'."carga_vCepo()".'" class="letra_frm"> <option value="">Seleccionar</option>';
				   ...
				   while ($row = mysql_fetch_row($result)){
                        ...
                        if ($S2_11_DI_COD==substr($row[3],4,2)) {  echo '<option value="'.substr($row[3],4,2).'" selected="selected">'.utf8_decode($row[6]).'</option>'; } else
