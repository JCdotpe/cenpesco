...
$c=0;
$sql="SELECT c.nota, c.id_examen, r.id, r.ap_paterno, r.ap_materno, r.nombre1, r.nombre2, r.dni FROM cap_calificacion AS c INNER JOIN regs AS r on(c.id=r.id) WHERE  c.id_examen='".$id_examen."' AND c.id_modulo='".$_SESSION["seccion"]."' GROUP BY  dni ORDER BY r.ap_paterno ASC";  
