...
<div class=panel>
  <p>&nbsp;</p>
  <p><span class="titulo2">Aula Virtual | Calificaciones Obtenidas<a href="agregar_notas.php" class="titulo2"></a></span><br />
  </p>
  <hr />
  <table width="624" border="1" cellpadding="3" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;">
    <tr>
      <td colspan="4" align="left" valign="middle" bgcolor="#D7FFD7" ><span class="titulo3"><strong>Mis calificaciones</strong></span></td>
      </tr>

    <tr>
      <td width="345" align="left" valign="middle" bgcolor="#99FF66" class="subtitulo"> <strong>Nombre de Evaluaci&oacute;n</strong></td>
      <td width="59" align="center" valign="middle" bgcolor="#99FF66" class="subtitulo"><strong>Nota</strong></td>
      <td width="65" align="center" valign="middle" bgcolor="#99FF66" class="subtitulo"><strong>Peso</strong></td>
      <td width="121" align="center" valign="middle" bgcolor="#99FF66" class="subtitulo"><strong>Verificaci&oacute;n</strong></td>
      </tr>
<?php  
$dni=$_SESSION["dni"];
$result = mysql_query("SELECT SUM(nota*peso) AS promedio FROM  cap_calificacion  WHERE  dni='".$dni."'");
...
function nota($nota,$dni)
{
$result = mysql_query("SELECT * FROM  cap_calificacion  WHERE  id_examen='".$nota."' AND dni='".$dni."'");
while ($row = mysql_fetch_array($result))
 {
  $nn=$row["nota"]; 
 }
...
$result = mysql_query("SELECT * FROM  cap_examen ORDER BY id_examen ASC")     ;
 while ($row = mysql_fetch_array($result))
 {
  ...
  if(($row["hora_ini"]<=$hora and $row["fecha"]<=$fecha) or  nota($row["id_examen"],$dni)!=0)
  {
  $nota=nota($row["id_examen"],$dni);
  }
  else
  {
   $nota='';
  ...
  if($row["tipo"]==1 or $row["tipo"]==2)
  {
	  ...
	  $link='<a href="detalle.php?id_examen='.$row["id_examen"].'">Detalle</a>'; 
 ...
 ?>
    <tr>
      <td align="left" valign="middle" class="subtitulo"><strong><strong><?php echo $row[1];  ?></strong></strong></td>
      <td align="center" valign="middle" class="subtitulo"><strong><?php echo $nota  ?></strong></td>
      <td align="center" valign="middle" class="subtitulo"><?php echo ($row["peso"]*100).' %';  ?></td>
      <td align="center" valign="middle" class="subtitulo"><span class="subtitulo"><?php echo $link;  ?></span></td>
      </tr> 
<?php
...
?>
    <tr>
      <td align="left" valign="middle" bgcolor="#FFFF99" class="subtitulo"><strong>Promedio general acumulado</strong></td>
      <td align="center" valign="middle" bgcolor="#FFFF99" class="subtitulo"><strong><?php echo $promedio; ?></strong></td>
      <td align="center" valign="middle" bgcolor="#FFFF99" class="subtitulo"><strong>100%</strong></td>
      <td align="center" valign="middle" bgcolor="#FFFF99" class="subtitulo">&nbsp;</td>
    </tr>
