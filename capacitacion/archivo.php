...
<div class=panel>
  ...
  <table width="621" border="0" cellpadding="6" cellspacing="0">
    <tr>
      <td width="429" align="left" valign="middle" class="titulo3">Lista de publicaciones </td>
      <td width="168" align="center" valign="middle" class="titulo3">Ver/descargar</td>
      </tr>
      <?php  
	  $c=0;
	  $result = mysql_query("SELECT * FROM  archivo ORDER BY fecha DESC");
		 while ($row = mysql_fetch_row($result))
			{
              $c=$c+1;
	  ...
	  ?>
    <tr>
      <td align="left" valign="middle" class="subtitulo"><?php  echo '<span class="subtitulo"> '.$c.'. '.$row[1].'</span>'; ?></td>
      <td align="center" valign="middle"><a href="<?php echo $row[3]; ?>" target="_blank"><img src="fondos/archivos.jpg" width="55" height="55" border="0" alt="<?php echo $row[1]; ?>" /></a></td>
      </tr>
