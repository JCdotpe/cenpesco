...
var provincia;
document.getElementById("S2_9_DD").value=document.getElementById("S2_9_DD_COD").options[document.getElementById("S2_9_DD_COD").selectedIndex].text;
...
ajax.open("GET", "provincia_uproceso.php?coddep="+coddep,true);
