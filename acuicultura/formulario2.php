        ...
        <tr id="regla2_1">
          <td align="left"><table width="960" border="0" cellpadding="1" cellspacing="0" >
            ...
            <tr id="hijo1">
              ...
              <td align="center" valign="middle"><input name="s2_24_9_1" type="text" id="s2_24_9_1" onkeypress="return numeros12(event)" value="<?php echo $s2_24_9_1; ?>" size="3" maxlength="1" onkeyup="return edad_n('s2_24_10_1',this.name)" onchange="return salta_ie('s2_24_4_1a',this.name,'s2_24_10_1','s2_24_11_1','s2_24_2_2')" /></td>
