...
echo '<select name="s2_10_ccpp_cod" id="s2_10_ccpp_cod" onchange="'."carga_rPoblado1()".'" class="letra_frm"> <option value="">Seleccionar</option>';
				   ...
				   while ($row = mysql_fetch_array($result)){
                        ...
                        if ($s2_10_ccpp_cod==$row['CODCCPP']) {  echo '<option value="'.$row['CODCCPP'].'" selected="selected">'.utf8_encode($row['CENTRO_POBLADO']).'</option>'; } else
