...
$sql="INSERT INTO  cap_percepcion (docente,dni,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13) VALUES ('".$docente."','".$dni."','".$p1."','".$p2."','".$p3."','".$p4."','".$p5."','".$p6."','".$p7."','".$p8."','".$p9."','".$p10."','".$p11."','".$p12."','".$p13."',,'".$id."')";
